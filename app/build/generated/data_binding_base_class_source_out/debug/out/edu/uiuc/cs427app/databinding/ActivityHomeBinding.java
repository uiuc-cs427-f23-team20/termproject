...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogout,
      @NonNull TextView cityInfo, @NonNull LinearLayout details, @NonNull Button mapButton,
      @NonNull TextView textView3, @NonNull TextView welcomeText) {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHomeBinding((ConstraintLayout) rootView, btnLogout, cityInfo, details,
          mapButton, textView3, welcomeText);
    }
